...
vim.keymap.set("n", "<Space>ff", '<cmd>lua require("telescope.builtin").find_files({ find_command = { "fd","-tf","-tl"}})<cr>', { silent = true })
...
vim.keymap.set("t", "<tab>", "<c-\\><c-n>:bn<cr>", { silent = true })
